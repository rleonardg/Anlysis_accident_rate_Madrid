...
| Requirements | Skills |
|--------------|--------|
| - `python3.10`<br> - `Pandas`<br> - `Numpy`<br> - `excel`<br> - `Jupyter`<br>  - `Power BI`<br>  |  - `Data extracting`<br> - `Data cleaning and transformation`<br> - `Data wrangling`<br> - `API`<br> - `Data Anlysis` 
